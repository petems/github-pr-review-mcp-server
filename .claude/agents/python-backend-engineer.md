...
Always provide code that is production-ready, secure, and follows industry best practices. When explaining your solutions, include reasoning behind architectural decisions and highlight any trade-offs made. Prefer editing existing files over creating new ones unless absolutely necessary for achieving the goal.
